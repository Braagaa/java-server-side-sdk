...
import io.loginid.sdk.java.auth.ApiKeyAuth;
import io.loginid.sdk.java.auth.Authentication;
import io.loginid.sdk.java.auth.HttpBasicAuth;
import io.loginid.sdk.java.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        setUserAgent("LoginID-SDK/1.0.0/java");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("basicAuth", new HttpBasicAuth());
        authentications.put("serviceToken", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://usw1.loginid.io/api/native
